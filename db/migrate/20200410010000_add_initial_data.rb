class AddInitialData < ActiveRecord::Migration[6.0]
  def up
    ...
    ApplicationRecord.connection.execute(<<~SQL)
      ...
      (created_at, id, name, updated_at)
      VALUES
      (CURRENT_TIMESTAMP, 1, 'Ounce', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 2, 'Gram', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 3, 'Pound', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 4, 'Kilogram', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 5, 'Pinch', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 6, 'Liter', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 7, 'Fluid Ounce', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 8, 'Gallon', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 9, 'Pint', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 10, 'Quart', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 11, 'Milliliter', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 12, 'Drop', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 13, 'Cup', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 14, 'Tablespoon', CURRENT_TIMESTAMP),
      (CURRENT_TIMESTAMP, 15, 'Teaspoon', CURRENT_TIMESTAMP)
    SQL
  end
